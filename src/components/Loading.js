...
export default class Loading extends React.Component {
  ...
  _getLoading(props) {
    ...
    if (this.offsetY != 0 || this.offsetX != 0) {
      offsetStyle.top =
        SCREEN_HEIGHT / 2 + this.offsetY / 2 - Loading.LOADING_HEIGHT / 2;
      offsetStyle.left =
        SCREEN_WIDTH / 2 + this.offsetX / 2 - Loading.LOADING_WIDTH / 2;
    }
    return (
      <View
        pointerEvents={!!props && props.pointerEvents ? "none" : "auto"}
